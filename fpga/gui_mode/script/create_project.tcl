...
#
# Generated by Vivado on Fri Feb 28 05:30:56 -0500 2025
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/ip_repo/dsp_modem"] [file normalize "$origin_dir/ip_repo/spi_full2half_duplex_adapter"]" $obj
...
set files [list \
 ...
 [file normalize "${origin_dir}/ip/util/spi_full2half_duplex.v"] \
 [file normalize "${origin_dir}/ip/util/params.vh"] \
 [file normalize "${origin_dir}/ip/demodulator_top_wrapper.v"] \
 [file normalize "${origin_dir}/ip/modulator_top_wrapper.v"] \
...
set file "$origin_dir/ip/util/spi_full2half_duplex.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/ip/demodulator_top_wrapper.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/ip/modulator_top_wrapper.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
