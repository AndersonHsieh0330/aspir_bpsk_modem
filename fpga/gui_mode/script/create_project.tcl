...
#
# Generated by Vivado on Mon Jul 08 17:28:10 EDT 2024
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/ip/util/sine_lut.v"]"\
 "[file normalize "$origin_dir/ip/util/sine_lut_sample.v"]"\
 "[file normalize "$origin_dir/ip/util/params.vh"]"\
 "[file normalize "$origin_dir/ip/util/sine_lut.v"]"\
 "[file normalize "$origin_dir/test/sine_lut_test.sv"]"\
  ]
  foreach ifile $files {
...
set_property -name "webtalk.xsim_launch_sim" -value "184" -objects $obj
...
set file "$origin_dir/ip/util/sine_lut.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/ip/util/sine_lut_sample.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
# Create 'sine_lut_test' fileset (if not found)
if {[string equal [get_filesets -quiet sine_lut_test] ""]} {
  create_fileset -simset sine_lut_test
}

# Set 'sine_lut_test' fileset object
set obj [get_filesets sine_lut_test]
set files [list \
 [file normalize "${origin_dir}/ip/util/params.vh"] \
 [file normalize "${origin_dir}/ip/util/sine_lut.v"] \
 [file normalize "${origin_dir}/test/sine_lut_test.sv"] \
...
# Set 'sine_lut_test' fileset file properties for remote files
set file "$origin_dir/ip/util/params.vh"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sine_lut_test] [list "*$file"]]
...
set file "$origin_dir/test/sine_lut_test.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sine_lut_test] [list "*$file"]]
...
# Set 'sine_lut_test' fileset file properties for local files
# None

# Set 'sine_lut_test' fileset properties
set obj [get_filesets sine_lut_test]
set_property -name "32bit" -value "0" -objects $obj
set_property -name "configure_for_gui_mode" -value "0" -objects $obj
set_property -name "define" -value "" -objects $obj
...
set_property -name "include_dirs" -value "" -objects $obj
set_property -name "incremental" -value "1" -objects $obj
set_property -name "name" -value "sine_lut_test" -objects $obj
set_property -name "nl.cell" -value "" -objects $obj
set_property -name "nl.incl_unisim_models" -value "0" -objects $obj
set_property -name "nl.process_corner" -value "slow" -objects $obj
set_property -name "nl.rename_top" -value "" -objects $obj
...
set_property -name "systemc_include_dirs" -value "" -objects $obj
set_property -name "top" -value "sine_lut_test" -objects $obj
set_property -name "top_lib" -value "xil_defaultlib" -objects $obj
set_property -name "transport_int_delay" -value "0" -objects $obj
set_property -name "transport_path_delay" -value "0" -objects $obj
set_property -name "unifast" -value "0" -objects $obj
