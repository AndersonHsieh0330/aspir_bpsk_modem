...
#
# Generated by Vivado on Wed Jul 10 14:07:16 EDT 2024
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/vivado_output/aspir_dsp_modem.sim/cosine_lut_test/cosine_lut_test_behav.wcfg"]"\
  ]
  foreach ifile $files {
 ...
 "[file normalize "$origin_dir/ip/util/params.vh"]"\
 "[file normalize "$origin_dir/ip/util/cosine_lut.v"]"\
 "[file normalize "$origin_dir/test/cosine_lut_test.sv"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set_property -name "webtalk.xsim_launch_sim" -value "247" -objects $obj
...
set added_files [add_files -fileset cosine_lut_test $files]
...
set file "$origin_dir/test/cosine_lut_test.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets cosine_lut_test] [list "*$file"]]
...
set file "cosine_lut_test/cosine_lut_test_behav.wcfg"
set file_obj [get_files -of_objects [get_filesets cosine_lut_test] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
