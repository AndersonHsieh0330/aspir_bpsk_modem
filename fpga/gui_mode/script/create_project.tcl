...
#
# Generated by Vivado on Tue Feb 04 04:35:38 -0500 2025
...
set_property -name "top" -value "bpsk_modem_top" -objects $obj
...
set files [list \
 ...
 [file normalize "${origin_dir}/ip/dsp_modem_top.sv"] \
 [file normalize "${origin_dir}/ip/util/fixdt_rounder.sv"] \
 [file normalize "${origin_dir}/ip/util/adder.sv"] \
]
add_files -norecurse -fileset $obj $files
...
set file "$origin_dir/ip/util/adder.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "top" -value "bpsk_modem_top" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_file" -value "ip/bpsk/bpsk_modem_top.sv" -objects $obj
