...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_interconnect_0_read_fifo, and set properties
  set axi_interconnect_0_read_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_interconnect_0_read_fifo ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
   CONFIG.NUM_SI {1} \
   ...
   CONFIG.STRATEGY {0} \
 ] $axi_interconnect_0_read_fifo

  # Create instance: axi_interconnect_1_write_fifo, and set properties
  set axi_interconnect_1_write_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_interconnect_1_write_fifo ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
 ] $axi_interconnect_1_write_fifo
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins axi_dma_0/M_AXI_MM2S] [get_bd_intf_pins axi_interconnect_1_write_fifo/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins axi_interconnect_0_read_fifo/S00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_read_M00_AXI [get_bd_intf_pins axi_interconnect_0_read_fifo/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net axi_interconnect_1_write_M00_AXI [get_bd_intf_pins axi_interconnect_1_write_fifo/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP1]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0_read_fifo/ACLK] [get_bd_pins axi_interconnect_0_read_fifo/M00_ACLK] [get_bd_pins axi_interconnect_0_read_fifo/S00_ACLK] [get_bd_pins axi_interconnect_1_write_fifo/ACLK] [get_bd_pins axi_interconnect_1_write_fifo/M00_ACLK] [get_bd_pins axi_interconnect_1_write_fifo/S00_ACLK] [get_bd_pins axis_data_fifo_0_pl2ps/m_axis_aclk] [get_bd_pins axis_data_fifo_0_ps2pl/s_axis_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0_read_fifo/ARESETN] [get_bd_pins axi_interconnect_0_read_fifo/M00_ARESETN] [get_bd_pins axi_interconnect_0_read_fifo/S00_ARESETN] [get_bd_pins axi_interconnect_1_write_fifo/ARESETN] [get_bd_pins axi_interconnect_1_write_fifo/M00_ARESETN] [get_bd_pins axi_interconnect_1_write_fifo/S00_ARESETN] [get_bd_pins axis_data_fifo_0_ps2pl/s_axis_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
