...
--               C:/Users/andy1/repos/award-winning-fydp/fpga/gui_mode/bd/aspir_bd_top/ip/aspir_bd_top_util_ds_buf_0_2/aspir_bd_top_util_ds_buf_0_2_sim_netlist.vhdl
-- Design      : aspir_bd_top_util_ds_buf_0_2
...
entity aspir_bd_top_util_ds_buf_0_2_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of aspir_bd_top_util_ds_buf_0_2_util_ds_buf : entity is 1;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of aspir_bd_top_util_ds_buf_0_2_util_ds_buf : entity is "IBUFDS";
  attribute C_SIZE : integer;
  attribute C_SIZE of aspir_bd_top_util_ds_buf_0_2_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of aspir_bd_top_util_ds_buf_0_2_util_ds_buf : entity is "util_ds_buf";
end aspir_bd_top_util_ds_buf_0_2_util_ds_buf;

architecture STRUCTURE of aspir_bd_top_util_ds_buf_0_2_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity aspir_bd_top_util_ds_buf_0_2 is
  port (
    IBUF_DS_P : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_DS_N : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_OUT : out STD_LOGIC_VECTOR ( 0 to 0 )
  ...
  attribute NotValidForBitStream of aspir_bd_top_util_ds_buf_0_2 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of aspir_bd_top_util_ds_buf_0_2 : entity is "aspir_bd_top_util_ds_buf_0_2,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of aspir_bd_top_util_ds_buf_0_2 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of aspir_bd_top_util_ds_buf_0_2 : entity is "util_ds_buf,Vivado 2019.1";
end aspir_bd_top_util_ds_buf_0_2;

architecture STRUCTURE of aspir_bd_top_util_ds_buf_0_2 is
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 250000000, PHASE 0.000, CLK_DOMAIN aspir_bd_top_ADC_DCO_P, INSERT_VIP 0";
begin
U0: entity work.aspir_bd_top_util_ds_buf_0_2_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
