...
--               C:/Users/andy1/repos/award-winning-fydp/fpga/gui_mode/bd/aspir_bd_top/ip/aspir_bd_top_util_ds_buf_0_3/aspir_bd_top_util_ds_buf_0_3_sim_netlist.vhdl
...
entity aspir_bd_top_util_ds_buf_0_3_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of aspir_bd_top_util_ds_buf_0_3_util_ds_buf : entity is 1;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of aspir_bd_top_util_ds_buf_0_3_util_ds_buf : entity is "OBUFDS";
  attribute C_SIZE : integer;
  attribute C_SIZE of aspir_bd_top_util_ds_buf_0_3_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of aspir_bd_top_util_ds_buf_0_3_util_ds_buf : entity is "util_ds_buf";
end aspir_bd_top_util_ds_buf_0_3_util_ds_buf;

architecture STRUCTURE of aspir_bd_top_util_ds_buf_0_3_util_ds_buf is
...
entity aspir_bd_top_util_ds_buf_0_3 is
  ...
  attribute NotValidForBitStream of aspir_bd_top_util_ds_buf_0_3 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of aspir_bd_top_util_ds_buf_0_3 : entity is "aspir_bd_top_util_ds_buf_0_3,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of aspir_bd_top_util_ds_buf_0_3 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of aspir_bd_top_util_ds_buf_0_3 : entity is "util_ds_buf,Vivado 2019.1";
end aspir_bd_top_util_ds_buf_0_3;

architecture STRUCTURE of aspir_bd_top_util_ds_buf_0_3 is
  ...
  attribute x_interface_parameter of OBUF_DS_N : signal is "XIL_INTERFACENAME OBUF_DS_N, FREQ_HZ 250000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0";
  attribute x_interface_info of OBUF_DS_P : signal is "xilinx.com:signal:clock:1.0 OBUF_DS_P CLK";
  attribute x_interface_parameter of OBUF_DS_P : signal is "XIL_INTERFACENAME OBUF_DS_P, FREQ_HZ 250000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0";
  attribute x_interface_info of OBUF_IN : signal is "xilinx.com:signal:clock:1.0 OBUF_IN CLK";
  attribute x_interface_parameter of OBUF_IN : signal is "XIL_INTERFACENAME OBUF_IN, FREQ_HZ 250000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0";
begin
U0: entity work.aspir_bd_top_util_ds_buf_0_3_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
