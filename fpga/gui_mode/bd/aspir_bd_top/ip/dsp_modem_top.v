...
axis_fifo_ctrl_ps2pl axis_fifo_ctrl_ps2pl_inst (
    .clk(dac_dco_clk),
    .rst_n(mod_resetn),
    .s_axis_tdata(ps2pl_fifo_m_axis_tdata),
    .s_axis_tkeep(ps2pl_fifo_m_axis_tkeep),
    .s_axis_tlast(ps2pl_fifo_m_axis_tlast),
    .s_axis_tready(ps2pl_fifo_m_axis_tready),
    .s_axis_tvalid(ps2pl_fifo_m_axis_tvalid),
...
differential_decoder differential_decoder_inst (
    ...
    .data_out(decoded_demodulator_data_out)
);
...
axis_fifo_ctrl_pl2ps axis_fifo_ctrl_pl2ps_inst (
    ...
    .m_axis_tdata(pl2ps_fifo_s_axis_tdata),
    .m_axis_tkeep(pl2ps_fifo_s_axis_tkeep),
    .m_axis_tlast(pl2ps_fifo_s_axis_tlast),
    .m_axis_tready(pl2ps_fifo_s_axis_tready),
    .m_axis_tvalid(pl2ps_fifo_s_axis_tvalid)
);
