...
-- Command     : write_vhdl -force -mode funcsim -rename_top aspir_bd_top_adc_data_diff_buf1_3 -prefix
--               aspir_bd_top_adc_data_diff_buf1_3_ aspir_bd_top_util_ds_buf_0_1_sim_netlist.vhdl
...
entity aspir_bd_top_adc_data_diff_buf1_3_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of aspir_bd_top_adc_data_diff_buf1_3_util_ds_buf : entity is 1;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of aspir_bd_top_adc_data_diff_buf1_3_util_ds_buf : entity is "IBUFDS";
  attribute C_SIZE : integer;
  attribute C_SIZE of aspir_bd_top_adc_data_diff_buf1_3_util_ds_buf : entity is 1;
end aspir_bd_top_adc_data_diff_buf1_3_util_ds_buf;

architecture STRUCTURE of aspir_bd_top_adc_data_diff_buf1_3_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity aspir_bd_top_adc_data_diff_buf1_3 is
  port (
    IBUF_DS_P : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_DS_N : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_OUT : out STD_LOGIC_VECTOR ( 0 to 0 )
  ...
  attribute NotValidForBitStream of aspir_bd_top_adc_data_diff_buf1_3 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of aspir_bd_top_adc_data_diff_buf1_3 : entity is "aspir_bd_top_util_ds_buf_0_1,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of aspir_bd_top_adc_data_diff_buf1_3 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of aspir_bd_top_adc_data_diff_buf1_3 : entity is "util_ds_buf,Vivado 2019.1";
end aspir_bd_top_adc_data_diff_buf1_3;

architecture STRUCTURE of aspir_bd_top_adc_data_diff_buf1_3 is
...
begin
U0: entity work.aspir_bd_top_adc_data_diff_buf1_3_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
